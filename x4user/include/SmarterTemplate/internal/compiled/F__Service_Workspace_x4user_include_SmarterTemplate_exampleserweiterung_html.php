...
require_once "F:/Service/Workspace/x4user/include/SmarterTemplate/examples/../internal/extensions/current_date.php";
require_once "F:/Service/Workspace/x4user/include/SmarterTemplate/examples/../internal/extensions/current_time.php";
...
?><?php $TIME_GENERATED = round(microtime (), 4); ?><table style="background-color: rgb(204, 204, 204);" border="0" cellpadding="2" cellspacing="1" width="100%">
	<tr style="background-color: rgb(255, 255, 255);" valign="top">
		<td>
			<a href="grundlagen.php">zurueck</a> 
			| <a href="index.php">Uebersicht</a> 
			| <a href="erweiterung_argumente.php">weiter</a> 
...
<table style="background-color: rgb(204, 204, 204);" border="0" cellpadding="2" cellspacing="1" width="100%">
	<tr style="background-color: rgb(255, 255, 255);" valign="top">
		<td colspan="3"><center><b>Erweiterungen</b></center></td>
	</tr>
	<tr style="background-color: rgb(255, 255, 255);" valign="top">
		<td colspan="2"><b>ohne Argumente</b></td>
	</tr>
	<tr style="background-color: rgb(255, 255, 255);" valign="top">
	...
	<tr style="background-color: rgb(255, 255, 255);" valign="top">
		<td><b>Ausgabe</b></td>
		<td><?php echo stecurrent_date (  ); ?>, <?php echo stecurrent_time (  ); ?></td>
	</tr>
</table>
