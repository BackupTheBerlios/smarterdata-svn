...
?> <a href="#<?php echo $loop[1]['value']['hash']; ?>"><?php echo stehtmlentities ( $loop[1]['value']['name'] ); ?></a> (<?php echo stehtmlentities ( $loop[1]['value']['category'] ); ?>)<br>
<?php } } ?></div>
...
?>
	<tr>
		<td
			colspan="2"
			class="product_headline_name"><a name="<?php echo $loop[1]['value']['hash']; ?>" /><?php echo stehtmlentities ( $loop[1]['value']['category'] ); ?>
	...
	<tr valign="top">
		...
		<div
			...
			width="100%"><b><?php echo stehtmlentities ( $loop[1]['value']['headline'] ); ?>:</b>
		<ul>
			<?php
	...
	<tr valign="top">
		...
		<table
			...
			<tr valign="top">
				...
				<div
					class="seealsosideinside"
					width="100%"><i><b><?php echo stehtmlentities ( $loop[1]['value']['langtext']['conformity'] ); ?>:</b></i>
				<ul>
					<?php
...
?>
				...
				<div
					class="seealsosideinside"
					width="100%"><i><b><?php echo stehtmlentities ( $loop[1]['value']['langtext']['datasheet'] ); ?>:</b></i>
				<ul>
					<?php
...
?>
					<li><img
						...
						width="19"
						height="18"
						style="vertical-align:middle"><a href="Documents/Datasheet/<?php echo $loop[2]['value']['path']; ?>"><?php echo stehtmlentities ( $loop[2]['value']['name'] ); ?></a></li>
					<?php } } ?>
				</ul>
				</div>
				...
				<div
					class="seealsosideinside"
					width="100%"><i><b><?php echo stehtmlentities ( $loop[1]['value']['langtext']['handbuch'] ); ?>:</b></i>
				<ul>
					<?php
...
?>
					<li><img
						...
						width="19"
						height="18"
						style="vertical-align:middle"><a href="Documents/Manual/<?php echo $loop[2]['value']['path']; ?>"><?php echo stehtmlentities ( $loop[2]['value']['name'] ); ?></a></li>
					<?php } } ?>
				</ul>
				</div>
				<?php } ?></td>
				...
				<div
					class="seealsosideinside"
					width="100%"><i><b><?php echo stehtmlentities ( $loop[1]['value']['langtext']['otherdoc'] ); ?>:</b></i>
				<ul>
					<?php
...
?>
					<li><img
						...
						width="19"
						height="18"
						style="vertical-align:middle"><a href="Documents/Otherdoc/<?php echo $loop[2]['value']['path']; ?>"><?php echo stehtmlentities ( $loop[2]['value']['name'] ); ?></a></li>
					<?php } } ?>
				</ul>
				</div>
				...
				<div
					class="seealsosideinside"
					width="100%"><i><b><?php echo stehtmlentities ( $loop[1]['value']['langtext']['siehe_auch'] ); ?>:</b></i>
				<ul>
					<?php
