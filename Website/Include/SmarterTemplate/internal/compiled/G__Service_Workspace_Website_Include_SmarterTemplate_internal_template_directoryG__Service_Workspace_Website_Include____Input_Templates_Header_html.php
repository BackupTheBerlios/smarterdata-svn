...
?> <?php if ( $loop[1]['value']['linkto'] > "" ) { ?><a href="<?php echo $loop[1]['value']['linkto']; ?>" border="0"><?php } ?> <img src="Images/<?php echo $loop[1]['value']['image']; ?>"> <?php if ( $loop[1]['value']['linkto'] > "" ) { ?></a><?php } ?><?php } } ?>
</div>
