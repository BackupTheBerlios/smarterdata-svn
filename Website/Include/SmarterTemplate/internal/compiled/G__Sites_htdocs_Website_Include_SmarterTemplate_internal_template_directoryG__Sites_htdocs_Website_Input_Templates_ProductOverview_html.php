...
?>
	<tr>
		<td
			colspan="2"
			class="product_headline_name"><a name="<?php echo $loop[1]['value']['hash']; ?>" /><?php echo $loop[1]['value']['category']; ?> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $loop[1]['value']['name']; ?></td>
	</tr>
	<tr valign="top">
...
?>
	...
	<tr valign="top">
		...
		<table
			...
			border="0">
			<tr valign="top">
				<td width="50%"><?php if ( $loop[1]['value']['datasheet'] > "" ) { ?>
				<div
					class="seealsosideinside"
